...
public class PaymentController {
    ...
    //private final IPaymentService paymentService = null;
  
	public PaymentController(IPaymentService paymentService) {
        this.paymentService = paymentService;
    }

// ADD THIS: supports GET /api/payments
    @GetMapping
    ...
    public ResponseEntity<PaymentDTO> create(@Valid @RequestBody PaymentDTO dto) {
        ...
        return ResponseEntity.created(URI.create("/api/payments/" + created.getPaymentId()))
                .body(created);
    }
