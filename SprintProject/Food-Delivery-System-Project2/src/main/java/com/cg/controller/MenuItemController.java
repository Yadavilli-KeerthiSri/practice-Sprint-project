...
public class MenuItemController {
    ...
    public String updateMenuItem(@PathVariable Integer id, MenuItem item) throws ResourceNotFound {
        menuItemService.updateMenuItem(id, item);
        return "redirect:/menuitems";
    }
 
    @GetMapping("/delete/{id}")
    public String deleteMenuItem(@PathVariable Integer id) throws ResourceNotFound {
